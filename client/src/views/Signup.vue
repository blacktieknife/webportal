    ...
    <div class="container" style="margin-top:10px">
        ...
        style="display:flex;flex-direction:column; align-items: center; ">
            <form @submit="handleFormSubmit" style="max-width:500px;width:100%">
                ...
                style="margin-top:15px;" id="signupBtn"
                :disabled="validForm" @click="handleFormSubmit">Submit</button>
            </form>
      ...
      if (this.email && this.pass && this.passConfirm) {
        if (this.passConfirm.length > 4) {
          if (this.pass === this.passConfirm) {
            ...
            this.addFormError('Check that passwords are exactly the same.');
          }
        }
      }
      return true;
